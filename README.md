...
Adapted for Getting and Coursera Cleaning Data Course Project
==================================================================
...
The data was adapted for the purposes of this project:
=============================================================
- The training and the test sets are merged to create one data set.
- Final data extracts only the measurements on the mean and standard deviation for each measurement.
- Activity names were renamed with descriptive activity names
- The data set was renamed with descriptive variable names.
